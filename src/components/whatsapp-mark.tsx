...
/**
 * Marca do WhatsApp. Vetor, não imagem: acompanha a cor do contexto e não
 * serrilha em tela de alta densidade.
 *
 * `filled` desenha o balão sólido com o telefone vazado — é a logo como as
 * pessoas reconhecem. Sem ele, só o contorno, pra usar junto de texto.
 */
  ...
  if (filled) {
    return (
      <svg
        ...
        aria-label="WhatsApp"
      >
        {/* Verde oficial da marca, fixo: logo não muda com o tema do app.
            O balão é sólido e o telefone é vazado em branco por cima — é
            assim que a logo é reconhecida. */}
        <path
          fill="#25D366"
        ...
        <path
          fill="#ffffff"
          d="M17.47 14.38c-.3-.15-1.75-.86-2.02-.96-.27-.1-.47-.15-.67.15-.2.3-.77.96-.94 1.16-.17.2-.35.22-.64.08-.3-.15-1.25-.46-2.38-1.47-.88-.79-1.47-1.76-1.65-2.05-.17-.3-.02-.46.13-.6.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.6-.92-2.2-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.48s1.07 2.88 1.22 3.08c.15.2 2.1 3.2 5.08 4.49.71.3 1.26.49 1.69.63.71.22 1.36.19 1.87.12.57-.09 1.75-.72 2-1.41.25-.7.25-1.29.17-1.41-.07-.13-.27-.2-.57-.35z"
        />
      </svg>
    );
  }
